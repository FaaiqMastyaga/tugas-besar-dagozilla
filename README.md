...
```
cd existing_repo
git remote add origin https://gitlab.com/kelompok-2-programming/tugas-besar-dagozilla.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kelompok-2-programming/tugas-besar-dagozilla/-/settings/integrations)
